...
```{r}
p1.h2 <- hypothesis(p1.brms.model.BL, "congruencenonMmatch = 0")
p1.h2
```
...
```{r}
p1.h3 <- hypothesis(p1.brms.model.BL, "audiosound:congruencenonMmatch = 0")
p1.h3
```
...
p1.single.trial.model <- lmer(rt ~ peak.time + peak.amplitude + audio + congruence + (audio + congruence | subject) + (audio + congruence | image_category), data=p1.single.trial.model.data)
