...
```{r}
p1.n4.single.trial.brms.model.formula <- bf(rt ~ 
...
p1.n4.single.trial.brms.model.priors.MI <- c(
...
p1.n4.single.trial.brms.model.MI <- brm(
  formula = p1.n4.single.trial.brms.model.formula,
  data = p1.n4.single.trial.model.data,
  prior = p1.n4.single.trial.brms.model.priors.MI,
  warmup = 1000,
  iter = 4000,
  save_pars = save_pars(group=FALSE),
  sample_prior = TRUE,
  chains = 8,
  cores = 8,
  file = "data/brms_fits/p1_n4_single_trial_model_MI"
)
```
