...
p1.congruence.brms.model.formula <- bf(
  is.congruent ~ peak.amplitude*peak.time*audio + (peak.amplitude*peak.time*audio | subject) + (peak.amplitude*peak.time*audio | stimulus), family=bernoulli(link = "logit"))
