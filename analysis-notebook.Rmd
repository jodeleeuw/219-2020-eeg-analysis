...
p1.brms.model.priors <- c(
  ...
  set_prior("normal(0,0.3)", coef="audiosound"),
  set_prior("normal(0,0.2)", coef="hemisphereright:audiosound")
)
...
p2.brms.model.priors <- c(
  set_prior("normal(0,0.1)", class="b"),
  set_prior("normal(0,0.31)", coef="audiosound"),
  set_prior("normal(0,0.5)", coef="congruencenonMmatch")
)
...
n4.brms.model.priors <- c(
  set_prior("normal(0,0.1)", class="b"),
  set_prior("normal(0,0.82)", coef="congruencenonMmatch")
)
...
p1.single.trial.brms.model.priors <- c(
  set_prior("normal(0,0.23)", coef="peak.time"),
