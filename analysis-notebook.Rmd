...
```{r}
rt.h1 <- hypothesis(rt.brms.model, "audio_typesound = 0")
rt.h1
plot(rt.h1)
```
...
```{r}
p1.h1 <- hypothesis(p1.brms.model, "audiosound = 0")
p1.h1
plot(p1.h1)
```

```{r}
p1.h2 <- hypothesis(p1.brms.model, "congruencenonMmatch = 0")
p1.h2
plot(p1.h2)
```

```{r}
p1.h3 <- hypothesis(p1.brms.model, "audiosound:congruencenonMmatch = 0")
p1.h3
plot(p1.h3)
```
...
p1.single.trial.brms.model.priors.MI <- c(
  set_prior("normal(0,0.56)", coef="peak.time"),
  set_prior("normal(0,0.56)", coef="peak.amplitude"),
  set_prior("normal(0,30)", coef="audiosound"),
  set_prior("normal(0,30)", coef="congruencenonMmatch")
)
...
p1.congruence.brms.model.priors.MI <- c(
  set_prior("normal(0, 0.56)", class="b")
)
...
summary(p1.congruence.brms.model)
```
...
summary(n4.single.trial.brms.model)
